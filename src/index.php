...
<body>
  ...
  <?php if ($parser->remaining): ?>
    <button class="message-tag message-tag-gray message-tag-inline" id="remaining" data-seconds="<?= $parser->remainingSeconds; ?>">
      <svg width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
  ...
  <?php if ($parser->registered): ?>
    <span class="message-tag message-tag-red registered-status">域名已注册</span>
  <?php endif; ?>
