    ...
    function i18n_dict(): array
    {
        ...
        $dict = [
            "zh" => [
                ...
                "multi_tag"          => "多域名",
                "multi_placeholder"  => "输入后缀，如 com、ke、net",
                "multi_intro_title"  => "多域名查询已开启",
                "multi_intro_desc"   => "输入一个后缀（如 com、ke、net），批量查询 a–z 及 nic/www/com/net/org/dns/api/pay 共 34 个域名。",
                "multi_empty_title"  => "无效的后缀",
                "multi_domains_unit" => "个域名",
                "multi_state_available"  => "可注册",
                "multi_state_registered" => "已注册",
                "multi_state_unknown"    => "未知",
                "multi_dns_note"     => "基于 SSL/DNS 快速探测；未知项点击可精确查询",
                "multi_modal_close"  => "关闭",
                "search_button"    => "查询",
                "clear"            => "清除",
                "hotkey_query"     => "查询",
                "hotkey_clear"     => "清除 / 失焦",
                ...
                "badge_for_sale"   => "正在出售",
                "badge_hold"       => "域名被 HOLD",
                "badge_transferring" => "正在转移",
                "badge_redemption" => "赎回期",
                "badge_pending_delete" => "即将删除",
                "badge_new_reg"    => "新注册",
                "badge_recently_transferred" => "近期转移",
                "badge_recently_updated" => "近期更新",
                "card_registrar"   => "注册商",
                "whois_server"     => "WHOIS 服务器",
                "registry_id"      => "注册局 ID",
                "registrar_iana"   => "注册商 ID",
                "registrar_address" => "注册商地址",
                "registrar_phone"  => "注册商电话",
                "reseller"         => "代理商",
                "abuse_contact"    => "滥用联系",
            ...
            "zh-TW" => [
                ...
                "multi_tag"          => "多網域",
                "multi_placeholder"  => "輸入後綴，如 com、ke、net",
                "multi_intro_title"  => "多網域查詢已開啟",
                "multi_intro_desc"   => "輸入一個後綴（如 com、ke、net），批次查詢 a–z 及 nic/www/com/net/org/dns/api/pay 共 34 個網域。",
                "multi_empty_title"  => "無效的後綴",
                "multi_domains_unit" => "個網域",
                "multi_state_available"  => "可註冊",
                "multi_state_registered" => "已註冊",
                "multi_state_unknown"    => "未知",
                "multi_dns_note"     => "基於 SSL/DNS 快速探測；未知項點擊可精確查詢",
                "multi_modal_close"  => "關閉",
                "search_button"    => "查詢",
                "clear"            => "清除",
                "hotkey_query"     => "查詢",
                "hotkey_clear"     => "清除 / 失焦",
                ...
                "badge_for_sale"   => "正在出售",
                "badge_hold"       => "網域被 HOLD",
                "badge_transferring" => "正在轉移",
                "badge_redemption" => "贖回期",
                "badge_pending_delete" => "即將刪除",
                "badge_new_reg"    => "新註冊",
                "badge_recently_transferred" => "近期轉移",
                "badge_recently_updated" => "近期更新",
                "card_registrar"   => "註冊商",
            ...
            "en" => [
                ...
                "multi_tag"          => "Multi",
                "multi_placeholder"  => "Enter a suffix, e.g. com, ke, net",
                "multi_intro_title"  => "Multi-domain lookup enabled",
                "multi_intro_desc"   => "Enter a suffix (e.g. com, ke, net) to batch-check 34 domains: a–z plus nic/www/com/net/org/dns/api/pay.",
                "multi_empty_title"  => "Invalid suffix",
                "multi_domains_unit" => "domains",
                "multi_state_available"  => "Available",
                "multi_state_registered" => "Registered",
                "multi_state_unknown"    => "Unknown",
                "multi_dns_note"     => "Fast SSL/DNS probe; click unknown rows for an exact lookup",
                "multi_modal_close"  => "Close",
                ...
                "badge_hold"       => "On HOLD",
                "badge_transferring" => "Transferring",
                "badge_redemption" => "Redemption",
                "badge_pending_delete" => "Pending delete",
                "badge_new_reg"    => "Newly registered",
                "badge_recently_transferred" => "Recently transferred",
                "badge_recently_updated" => "Recently updated",
            ...
            "ja" => [
                ...
                "multi_tag"          => "複数",
                "multi_placeholder"  => "サフィックスを入力（例：com、ke、net）",
                "multi_intro_title"  => "複数ドメイン検索が有効",
                "multi_intro_desc"   => "サフィックス（例：com、ke、net）を入力すると、a–z と nic/www/com/net/org/dns/api/pay の計 34 ドメインを一括照会します。",
                "multi_empty_title"  => "無効なサフィックス",
                "multi_domains_unit" => "ドメイン",
                "multi_state_available"  => "登録可能",
                "multi_state_registered" => "登録済み",
                "multi_state_unknown"    => "不明",
                "multi_dns_note"     => "SSL/DNS による高速判定；不明な項目はクリックで詳細照会",
                "multi_modal_close"  => "閉じる",
                "search_button"    => "検索",
                "clear"            => "クリア",
                "hotkey_query"     => "検索",
                ...
                "msg_error"        => "この TLD は���効ですが、レジストリの WHOIS/RDAP に一時的に接続できません。しばらくして再度お試しください。",
                "status_expired"   => "期限切れ",
                ...
                "badge_for_sale"   => "売却中",
                "badge_hold"       => "HOLD 状態",
                "badge_transferring" => "移管中",
                "badge_redemption" => "復旧期間",
                "badge_pending_delete" => "削除予定",
                "badge_new_reg"    => "新規登録",
                "badge_recently_transferred" => "最近移管",
                "badge_recently_updated" => "最近更新",
                "card_registrar"   => "レジストラ",
                "whois_server"     => "WHOIS サーバー",
                "registry_id"      => "レジストリ ID",
                "registrar_iana"   => "レジストラ IANA ID",
                "registrar_address" => "レジストラ住所",
                "registrar_phone"  => "レジストラ電話番号",
                "reseller"         => "リセラー",
                "abuse_contact"    => "不正利用の連絡先",
                "registrant_info"  => "登録者情報",
                "admin_contact"    => "管理者連絡先",
                "tech_contact"     => "技術連絡先",
                "contact_name"     => "氏名",
                "contact_org"      => "組織",
                "contact_location" => "地域",
                "dns_provider"     => "DNS プロバイダー",
                "email"            => "メール",
                "phone"            => "電話",
                "copy"             => "コピー",
                "copied"           => "コピー済み",
