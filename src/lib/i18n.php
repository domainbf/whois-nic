    ...
    function i18n_dict(): array
    {
        ...
        $dict = [
            ...
            "en" => [
                ...
                "prev_page"        => "Previous",
                "next_page"        => "Next",
                "msg_invalid"      => "❌ This is not a valid domain. Please check the format and try again.",
                ...
                "msg_available"    => "✅ Great news! This domain is available and ready to register.",
            ...
            "ja" => [
                ...
                "prev_page"        => "前へ",
                "next_page"        => "次へ",
                "msg_invalid"      => "❌ 有効なドメインではありません。形式を確認して再度お試しください。",
                ...
                "msg_available"    => "✅ おめでとうございます！このドメインは未登録で、すぐに取得できます。",
                "status_expired"   => "期限切れ",
