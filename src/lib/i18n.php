    ...
    function i18n_dict(): array
    {
        ...
        $dict = [
            ...
            "en" => [
                ...
                "title_available"  => "This domain is available",
                ...
                "msg_available"    => "No registration record found. You can register it now.",
            ...
            "ja" => [
                ...
                "msg_available"    => "登録記録が見つかりません。今すぐ取得できます。",
                "status_expired"   => "期限切れ",
