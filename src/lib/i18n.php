    ...
    function i18n_dict(): array
    {
        ...
        $dict = [
            "zh" => [
                ...
                "multi_dns_note"     => "无 RDAP 接口，仅依据 DNS 记录判断",
            ...
            "zh-TW" => [
                ...
                "multi_state_unknown"    => "未知",
                "multi_dns_note"     => "無 RDAP 介面，僅依 DNS 記錄判斷",
            ...
            "en" => [
                ...
                "multi_dns_note"     => "No RDAP; based on DNS records only",
            ...
            "ja" => [
                ...
                "multi_dns_note"     => "RDAP なし、DNS レコードのみで判定",
                ...
                "footer_ann4"      => "記録なし・保存なし・すべての検索データはお使���のブラウザ内のみ。",
