    ...
    function i18n_dict(): array
    {
        ...
        $dict = [
            "zh" => [
                ...
                "suggest_aria"     => "域名联想建议",
                "suggest_recent"   => "最近查询",
                "suggest_domains"  => "推荐域名",
                "status_registered" => "已注册",
                "status_available" => "未注册",
                "status_checking"  => "检测中",
                "clear"            => "清除",
                "hotkey_query"     => "查询",
                "hotkey_clear"     => "清除 / 失焦",
                ...
                "title_taken"      => "该域名已被注册",
                "title_error"      => "目前无法查询",
                "msg_invalid"      => "请输入正确后缀重新查询。",
                "msg_reserved"     => "域名已被注册局保留，暂不开放注册。",
                "msg_prohibited"   => "该域名被注册局禁止或限制注册。",
                "msg_unknown"      => "未找到该域名的注册信息。",
                "msg_available"    => "未查询到注册记录，您可以尝试注册！能否注册以注册局/注册商的实际政策为准。",
                "msg_taken"        => "该域名已被注册，但很抱歉、我无法为你提供详细信息。",
                "msg_error"        => "很遗憾，还后缀注册局不提供 WHOIS/RDAP 接口，暂时无法访问，请直接联系注册代理商或注册局直接咨询。",
                // 结果卡
                "status_expired"   => "已过期",
                ...
                "footer_ann3"      => "在售的域名，可通过进入[DOMAIN.BF]查看我的域名。",
            ...
            "zh-TW" => [
                ...
                "suggest_aria"     => "網域聯想建議",
                "suggest_recent"   => "最近查詢",
                "suggest_domains"  => "推薦網域",
                "status_registered" => "已註冊",
                "status_available" => "未註冊",
                "status_checking"  => "檢測中",
                "clear"            => "清除",
                "hotkey_query"     => "查詢",
                "hotkey_clear"     => "清除 / 失焦",
            ...
            "en" => [
                ...
                "suggest_aria"     => "Domain suggestions",
                "suggest_recent"   => "Recent",
                "suggest_domains"  => "Suggestions",
            ...
            "ja" => [
                ...
                "search_button"    => "検索",
                "suggest_aria"     => "ドメイン候補",
                "suggest_recent"   => "最近の検索",
                "suggest_domains"  => "おすすめ",
                "status_registered" => "登録済み",
                "status_available" => "未登録",
                "status_checking"  => "確認中",
                "clear"            => "クリア",
                "hotkey_query"     => "検索",
