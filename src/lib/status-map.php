...
return [
      ...
      // 无 client/server 前缀的通用状态词（多见于冷门 ccTLD，如 .md/nic.md）
      // 这些 registry 常在同一 "Domain state" 行里空格分隔多个状态词。
      'renewProhibited' => '禁止续费',
      'transferProhibited' => '禁止转移',
      'updateProhibited' => '禁止更新',
      'deleteProhibited' => '禁止删除',
      'createProhibited' => '禁止创建',
      'renewalProhibited' => '禁止续费',
      'blocked' => '已封锁',
      'reserved' => '保留',
      'frozen' => '已冻结',
      'locked' => '已锁定',
      ...
      'revoked' => '已吊销',
      'suspended' => '已暂停',
      'redemptionPeriodPendingDelete' => '赎回期（待删除）',
      'clientDeleteHold' => '客户删除暂停',
      'pendingDeleteRestorable' => '待删除（可恢复）',
      'noRenewal' => '不可续费',
      'outOfService' => '停止服务',
];
